...
Между командами и следующими prompt добавляется одна пустая строка. Это
сохраняет визуальный интервал между строками капсул в терминалах, где короткие
команды отображаются слишком плотно.
